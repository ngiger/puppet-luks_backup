...
Den Befehl @sudo rsnapshot -c /etc/rsnapshot.conf.example hourly@ ausführen und Ausgabe auf Fehler kontrollieren. Ggf.  Probleme wegen Zugriffsrechten lösen.
...
bc. 0 */4 * * * /usr/bin/rsnapshot -c /etc/rsnapshot.conf.example hourly
50 23 * * * /usr/bin/rsnapshot -c /etc/rsnapshot.conf.example daily
40 23 * * 6 /usr/bin/rsnapshot -c /etc/rsnapshot.conf.example weekly
30 23 1 * * /usr/bin/rsnapshot -c /etc/rsnapshot.conf.example monthly
20 23 1 1 * /usr/bin/rsnapshot -c /etc/rsnapshot.conf.example yearly
...
# AllowUsers backup benutzer1 benutzer2
# PermitRootLogin no
